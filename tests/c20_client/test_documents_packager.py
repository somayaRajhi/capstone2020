...
def test_file_name(single_documents):
    assert single_documents[0]['data'][0]['file_name'] == 'basic_documents.json'


def test_agency_acronym(single_documents):
    assert single_documents[0]['data'][0]['data']['agencyAcronym'] == 'test'


def test_data(single_documents):
    assert single_documents[0]['data'][0]['data']['data'] == 'test Documents'


def test_docket_id(single_documents):
    assert single_documents[0]['data'][0]['data']['docketId'] == 'docket-number-3'


def test_document_id(single_documents):
    assert single_documents[0]['data'][0]['data']['documentId'] == 'document-number-15'
...
def test_many_file_name(multiple_documents):
    assert multiple_documents[0]['data'][0]['file_name'] == 'basic_documents.json'
    assert multiple_documents[1]['data'][0]['file_name'] == 'basic_documents.json'


def test_many_agency_acronym(multiple_documents):
    assert multiple_documents[0]['data'][0]['data']['agencyAcronym'] == 'test'
    assert multiple_documents[1]['data'][0]['data']['agencyAcronym'] == 'test'


def test_many_data(multiple_documents):
    assert multiple_documents[0]['data'][0]['data']['data'] == 'test Documents'
    assert multiple_documents[1]['data'][0]['data']['data'] == 'test Documents 2'


def test_many_docket_id(multiple_documents):
    assert multiple_documents[0]['data'][0]['data']['docketId'] == 'docket-number-3'
    assert multiple_documents[1]['data'][0]['data']['docketId'] == 'docket-number-4'


def test_many_document_id(multiple_documents):
    assert multiple_documents[0]['data'][0]['data']['documentId'] == 'document-number-15'
    assert multiple_documents[1]['data'][0]['data']['documentId'] == 'document-number-16'
